...
import ru.sirbromate.magicmagic.objects.items.*;
...
public class ModItems {
    ...
    public static Item FIRE_STAFF = new FireStaff();
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, Main.locate("firestaff"), FIRE_STAFF);
    }
